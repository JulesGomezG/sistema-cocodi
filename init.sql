-- =================================================================
-- Script Definitivo - Modelo v15.1
-- =================================================================
...
CREATE TABLE IF NOT EXISTS Informes_de_Seguimiento (
  ...
  CONSTRAINT fk_informe_institucion FOREIGN KEY (id_institucion) REFERENCES Instituciones (id_institucion),
...
CREATE TABLE IF NOT EXISTS Recomendaciones (
  ...
  -- CAMBIO 1: Permitir que el informe sea nulo.
  id_informe INT NULL, 
  -- CAMBIO 2: Añadir una referencia directa y obligatoria a la institución.
  id_institucion INT NOT NULL,
  ...
  activo BOOLEAN NOT NULL DEFAULT TRUE,
  -- La llave foránea al informe se mantiene.
  CONSTRAINT fk_recomendacion_informe FOREIGN KEY (id_informe) REFERENCES Informes_de_Seguimiento (id_informe) ON DELETE CASCADE,
  -- CAMBIO 3: Añadir la nueva llave foránea a la institución.
  CONSTRAINT fk_recomendacion_institucion FOREIGN KEY (id_institucion) REFERENCES Instituciones (id_institucion) ON DELETE CASCADE
);
-- ===================================
...
CREATE TABLE IF NOT EXISTS Calendario_Sesiones (
  ...
  activo BOOLEAN NOT NULL DEFAULT TRUE,
  CONSTRAINT fk_calendario_institucion FOREIGN KEY (id_institucion) REFERENCES Instituciones (id_institucion),
  CONSTRAINT fk_calendario_organo FOREIGN KEY (id_organo_colegiado) REFERENCES Catalogo_Organos_Colegiados (id_organo_colegiado),
