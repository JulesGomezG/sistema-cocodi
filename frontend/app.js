...
document.addEventListener('DOMContentLoaded', () => {
    // --- NAVEGACIÓN PRINCIPAL (CORREGIDO: Selector específico) ---
    // Antes: document.querySelectorAll('.nav-link') -> Esto causaba el conflicto
    // Ahora: Solo selecciona los links dentro de '.main-nav'
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // Ocultar todas las secciones y quitar 'active' de todos los links del menú principal
            sections.forEach(section => section.classList.add('hidden'));
            navLinks.forEach(navLink => navLink.classList.remove('active'));
            
            // Mostrar la sección seleccionada y activar el link correspondiente
            ...
            if (sectionId === 'section-dashboard') {
                if (typeof switchView === 'function') { 
                    switchView('global');
                } else if (typeof initDashboardModule === 'function') {
                    initDashboardModule(); 
                }
            }
        });
    ...
    // --- CARGA INICIAL (Si Dashboard es la vista por defecto) ---
